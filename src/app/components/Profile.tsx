      ...
      <div className='grid grid-cols-5'>
        <div className='col-span-2 bg-[#ECF3FF] h-[900px]'>
          <div>
            ...
            <div className='px-6'>
              <div>
                <div className='text-[#059341] text-[18px] font-bold pb-4'>Contact information</div>
          ...
          <div>
            ...
            <div className='border-b-[1px] border-[#FB9F21] pb-10'>
              ...
              <div className='flex flex-col gap-1'>
                ...
                <p>
                  Experienced with React Hook, Next js, html, css, scss, JavaScript. Have experience
                  tools: Microsoft Office Word, Excel, PowerPoint, Visual Studio CodeSpecial Tools:
                  Jira, Git.
                </p>
