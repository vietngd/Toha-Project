        ...
        <div className='relative px-4 py-10 bg-slate-200 mx-8 md:mx-0 shadow rounded-3xl sm:p-10'>
          ...
          <div className='max-w-md mx-auto'>
            <div className='flex flex-col items-center space-x-5 justify-center text-[30px] font-semibold'>
              Welcome to Toha
              <p className='text-[16px] text-[#7a7979]'>Tạo tài khoản của bạn</p>
            </div>
            <div className='mt-5 flex flex-col gap-3'>
              ...
              <Controller
                ...
                rules={{ required: "Trường thông tin này là bắt buộc" }}
                render={({ field }) => (
                  <FormControl component='fieldset' fullWidth error={!!errors.phone}>
                    <Typography variant='body2' color='initial' fontWeight={600}>
                      Số điện thoại <RequireMark />
                    </Typography>
                    <TextField
                      {...field}
                      id='outlined-basic'
              ...
              <Controller
                ...
                rules={{ required: "Trường thông tin này là bắt buộc" }}
                render={({ field }) => (
                  <FormControl component='fieldset' fullWidth error={!!errors.confirmPassword}>
                    <Typography variant='body2' color='initial' fontWeight={600}>
                      Xác nhận mật khẩu <RequireMark />
                    </Typography>
                    <TextField
                      {...field}
                      id='outlined-basic'
            ...
            <div className='flex justify-center w-full items-center pt-4'>
              <div>
                <button className='flex items-center justify-center py-2 px-20 bg-white hover:bg-gray-200 focus:ring-blue-500 focus:ring-offset-blue-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg'>
                  ...
                  <span className='ml-2 text-[14px]'>Đăng ký với tài khoản Google</span>
                </button>
                <button className='flex items-center justify-center py-[5px] px-20 bg-white hover:bg-gray-200 focus:ring-blue-500 focus:ring-offset-blue-200 text-gray-700 w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 rounded-lg mt-4'>
                  ...
                  <span className='ml-2 text-[14px]'>Đăng ký với tài khoản Apple</span>
                </button>
              </div>
            </div>
            <div className='mt-5'>
