...
const WeatherToday = () => {
  return (
    <div className='duration-300 font-mono text-gray-700 group cursor-pointer relative overflow-hidden bg-[#bec3ca] w-[150px] h-[200px] dark:bg-[#22272B] rounded-3xl p-4 hover:w-[300px] hover:bg-blue-300 hover:dark:bg-[#0d4491]'>
      <h3 className='text-xl text-center'>Today</h3>
      <div className='gap-4 relative'>
        <svg
          viewBox='0 0 64 64'
          xmlns='http://www.w3.org/2000/svg'
          className='w-[80px] scale-[110%] ml-4'
        >
          <defs>
            <linearGradient
            ...
            <linearGradient y2='48.05' y1='42.95' x2='32.47' x1='29.53' id='d'></linearGradient>
            <linearGradient y2='48.05' y1='42.95' x2='39.47' x1='36.53' id='e'></linearGradient>
          </defs>
          <circle
            stroke-width='.5'
